...
public class PresentadorContactos {
    ...
    public Commands crearContacto(@RequestParam String nombre, @RequestParam String telefono,@RequestParam int posTipoContacto) throws AgendaException {
        
      if(posTipoContacto<0) return Command.lista(new Command("error","Seleccione el tipo de contacto"));
